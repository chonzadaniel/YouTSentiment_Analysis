...
# # def load_model_and_vectorizer(model_name, model_version, vectorizer_path):
# #     # Set MLflow tracking URI to your server
# #     mlflow.set_tracking_uri("http://ec2-18-208-150-23.compute-1.amazonaws.com:5000/")  # Replace with your MLflow tracking URI
# #     client = MlflowClient()
# #     model_uri = f"models:/{model_name}/{model_version}"
# #     model = mlflow.pyfunc.load_model(model_uri)
# #     with open(vectorizer_path, 'rb') as file:
...
@app.route('/')
def home():
    return "Welcome to the YouTube Sentiment Analysis API"
...
def predict():
    ...
    try:
        ...
        predictions = model.predict(transformed.toarray()).tolist()
